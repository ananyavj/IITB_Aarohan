...
const CalendarScreen = () => {
    ...
    // Data
    const monthEvents = useMonthEvents(now.getMonth(), now.getFullYear());
    const userCalendars = useCalendars();
                ...
                <div className="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Manage your study schedule and track important events
                        </p>
                    </div>
